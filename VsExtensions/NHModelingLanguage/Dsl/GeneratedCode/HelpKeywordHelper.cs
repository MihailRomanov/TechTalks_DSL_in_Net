...
namespace EPAM.NHModelingLanguage
{
	...
	/// </remarks>
	public partial class NHModelingLanguageHelpKeywordHelper : NHModelingLanguageHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new NHModelingLanguageHelpKeywordHelper.
		/// </summary>
		protected NHModelingLanguageHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the NHModelingLanguageHelpKeywordHelper.
		/// </summary>
		public static NHModelingLanguageHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class NHModelingLanguageHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new NHModelingLanguageHelpKeywordHelperBase.
		/// </summary>
		protected NHModelingLanguageHelpKeywordHelperBase()
			: base() { }
