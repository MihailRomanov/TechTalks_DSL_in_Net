...
namespace EPAM.NHModelingLanguage
{
	...
	/// </remarks>
	public partial class NHModelingLanguageToolboxHelper : NHModelingLanguageToolboxHelperBase 
	{
		/// <summary>
		/// Constructs a new NHModelingLanguageToolboxHelper.
		/// </summary>
		public NHModelingLanguageToolboxHelper(global::System.IServiceProvider serviceProvider)
	...
	public abstract class NHModelingLanguageToolboxHelperBase
	{
		/// <summary>
		/// Toolbox item filter string used to identify NHModelingLanguage toolbox items.  
		/// </summary>
		/// <remarks>
		/// See the MSDN documentation for the ToolboxItemFilterAttribute class for more information on toolbox
		/// item filters.
		/// </remarks>
		public const string ToolboxFilterString = "NHModelingLanguage.1.0";
		/// <summary>
		...
		/// <summary>
		/// Constructs a new NHModelingLanguageToolboxHelperBase.
		/// </summary>
		protected NHModelingLanguageToolboxHelperBase(global::System.IServiceProvider serviceProvider)
		{
		...
		public static string DefaultToolboxTabName
		{
			get
			{
				return global::EPAM.NHModelingLanguage.NHModelingLanguageDomainModel.SingletonResourceManager.GetString("NHModelingLanguageToolboxTab", global::System.Globalization.CultureInfo.CurrentUICulture);
			}
		}
		...
		public virtual DslDesign::ModelingToolboxItem GetToolboxItem(string itemId, DslModeling::Store store)
		{
			...
			global::System.Resources.ResourceManager resourceManager = global::EPAM.NHModelingLanguage.NHModelingLanguageDomainModel.SingletonResourceManager;
			global::System.Globalization.CultureInfo resourceCulture = global::System.Globalization.CultureInfo.CurrentUICulture;
			switch(itemId)
			{
				case "EPAM.NHModelingLanguage.EntityToolToolboxItem":
					// Add EntityTool shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"EPAM.NHModelingLanguage.EntityToolToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						...
						"EPAM.NHModelingLanguage.NHModelingLanguageToolboxTab", // Unique identifier (non-localized) for the toolbox item tab.
						resourceManager.GetString("NHModelingLanguageToolboxTab", resourceCulture), // Localized display name for the toolbox tab.
						"EntityTool", // F1 help keyword for the toolbox item.
						resourceManager.GetString("EntityToolToolboxTooltip", resourceCulture), // Localized tooltip text for the toolbox item.
						CreateElementToolPrototype(store, global::EPAM.NHModelingLanguage.Entity.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
						new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) 
						});
					break;
				case "EPAM.NHModelingLanguage.InheritanceToolToolboxItem":

					// Add InheritanceTool connector tool.
					result = new DslDesign::ModelingToolboxItem(
						"EPAM.NHModelingLanguage.InheritanceToolToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						...
						"EPAM.NHModelingLanguage.NHModelingLanguageToolboxTab", // Unique identifier (non-localized) for the toolbox item tab.
						resourceManager.GetString("NHModelingLanguageToolboxTab", resourceCulture), // Localized display name for the toolbox tab.
						"InheritanceTool", // F1 help keyword for the toolbox item.
		...
		protected DslModeling::Store ToolboxStore
		{
			...
			{ 
				if (toolboxStore==null)
				{
					...
					toolboxStore.LoadDomainModels(typeof(global::EPAM.NHModelingLanguage.NHModelingLanguageDomainModel));
