...
namespace EPAM.NHModelingLanguage
{
	...
	/// </summary>
	public static partial class EntityInheritedParentBuilder
	{
		...
		public static bool CanAcceptSource(DslModeling::ModelElement candidate)
		{
			...
			else if (candidate is global::EPAM.NHModelingLanguage.Entity)
			{ 
				return true;
			}
			else
			...
			else // Check combinations
			{
				if (candidateSource is global::EPAM.NHModelingLanguage.Entity)
				{
					if (candidateTarget is global::EPAM.NHModelingLanguage.Entity)
					{
						...
						if(sourceEntity == null || global::EPAM.NHModelingLanguage.EntityInheritedParent.GetLinkToParent(sourceEntity) != null) return false;
						if(targetEntity == null || sourceEntity == null || global::EPAM.NHModelingLanguage.EntityInheritedParent.GetLinks(sourceEntity, targetEntity).Count > 0) return false;
						return true;
					}
				}
	...
	internal partial class InheritanceToolConnectAction : DslDiagrams::ConnectAction
	{
		...
		private partial class InheritanceToolConnectionTypeBase : DslDiagrams::ConnectionType
		{
			...
			/// </summary>
			/// <remarks>
			/// This implementation delegates calls to the ConnectionBuilder EntityInheritedParentBuilder.
			/// </remarks>
			public override bool CanCreateConnection(DslDiagrams::ShapeElement sourceShapeElement, DslDiagrams::ShapeElement targetShapeElement, ref string connectionWarning)
			{
				...
				{				
					if(targetShapeElement == null)
					{
						return EntityInheritedParentBuilder.CanAcceptSource(sourceElement);
					}
					else
					{				
						return EntityInheritedParentBuilder.CanAcceptSourceAndTarget(sourceElement, targetElement);
					}
				}
				else
				{
			...
			public override void CreateConnection(DslDiagrams::ShapeElement sourceShapeElement, DslDiagrams::ShapeElement targetShapeElement, DslDiagrams::PaintFeedbackArgs paintFeedbackArgs)
			{
				...
				if(targetElement == null) targetElement = targetShapeElement;
				EntityInheritedParentBuilder.Connect(sourceElement, targetElement);
			}
		}
