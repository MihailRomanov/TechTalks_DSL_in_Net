...
namespace EPAM.NHModelingLanguage
{
	...
	/// </summary>
	internal partial class NHModelingLanguageDocView : NHModelingLanguageDocViewBase
	{
		/// <summary>
		/// Constructs a new NHModelingLanguageDocView.
		/// </summary>
		public NHModelingLanguageDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class NHModelingLanguageDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new NHModelingLanguageDocView.
		/// </summary>
		protected NHModelingLanguageDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			NHModelingLanguageDocDataBase docData = this.DocData as NHModelingLanguageDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for NHModelingLanguageDocViewBase should be an NHModelingLanguageDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::EPAM.NHModelingLanguage.NHDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::EPAM.NHModelingLanguage.NHDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::EPAM.NHModelingLanguage.NHModelingLanguageToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::EPAM.NHModelingLanguage.NHModelingLanguageToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.NHModelingLanguageDiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::EPAM.NHModelingLanguage.NHModelingLanguageHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::EPAM.NHModelingLanguage.NHModelingLanguageHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::EPAM.NHModelingLanguage.NHModelingLanguageHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
