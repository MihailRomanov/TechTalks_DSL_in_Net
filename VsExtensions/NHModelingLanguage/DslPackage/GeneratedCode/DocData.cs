...
namespace EPAM.NHModelingLanguage
{
	...
	/// </summary>
	internal partial class NHModelingLanguageDocData : NHModelingLanguageDocDataBase
	{
		/// <summary>
		/// Constructs a new NHModelingLanguageDocData.
		/// </summary>
		public NHModelingLanguageDocData(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) 
	...
	/// <summary>
	/// Class which represents a NHModelingLanguage document in memory.
	/// </summary>
	internal abstract partial class NHModelingLanguageDocDataBase : DslShell::ModelingDocData
	{
		...
		/// <summary>
		/// Constructs a new NHModelingLanguageDocDataBase.
		/// </summary>
		protected NHModelingLanguageDocDataBase(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) : base(serviceProvider, editorFactoryId)
		{
		}
		...
		protected override string FormatList
		{
			get
			{
				return global::EPAM.NHModelingLanguage.NHModelingLanguageDomainModel.SingletonResourceManager.GetString("FormatList"); 
			}
		}
		...
		protected virtual bool HandleBindingFailure(global::System.Exception exception)
		{
			...
			string errorMessage = string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
				global::EPAM.NHModelingLanguage.NHModelingLanguageDomainModel.SingletonResourceManager.GetString("BindingErrorOccurred"),
				exception.ToString());
		...
		{
			return new DslShell::VsValidationController(this.ServiceProvider, typeof(NHModelingLanguageExplorerToolWindow));
		}
		/// <summary>
		...
		protected override global::System.Collections.Generic.IList<global::System.Type> GetDomainModels()
		{
			...
			allTypes.Add(typeof(global::EPAM.NHModelingLanguage.NHModelingLanguageDomainModel));
		...
		protected virtual global::System.Collections.Generic.IEnumerable<global::System.Type> GetExtensionDomainModels()
		{
			...
			global::System.Collections.Generic.IEnumerable<global::System.Type> extensionDomainModels = this.ExtensionLocator.GetExtendingDomainModels(typeof(global::EPAM.NHModelingLanguage.NHModelingLanguageDomainModel));
		...
		protected override void Load(string fileName, bool isReload)
		{
			...
			global::EPAM.NHModelingLanguage.NHModel modelRoot = null;
			...
			global::EPAM.NHModelingLanguage.NHModelingLanguageDomainModel.EnableDiagramRules(this.Store);
			string diagramFileName = fileName + this.DiagramExtension;
			
			modelRoot = global::EPAM.NHModelingLanguage.NHModelingLanguageSerializationHelper.Instance.LoadModelAndDiagram(serializationResult, this.GetModelPartition(), fileName, this.GetDiagramPartition(), diagramFileName, schemaResolver, null /* no load-time validation */, this.SerializerLocator);
			...
			{	
				...
				throw new global::System.InvalidOperationException(global::EPAM.NHModelingLanguage.NHModelingLanguageDomainModel.SingletonResourceManager.GetString("CannotOpenDocument"));
			}
			else
			{
						...
						if (itemId != global::Microsoft.VisualStudio.VSConstants.VSITEMID_NIL)
						{
							...
							if (this.diagramDocumentLockHolder == null)
							{
								throw new global::System.InvalidOperationException(string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
													global::EPAM.NHModelingLanguage.NHModelingLanguageDomainModel.SingletonResourceManager.GetString("CannotCloseExistingDiagramDocument"),
													diagramFileName));
							}
						}
					}
		...
		protected virtual void OnDocumentLoaded()
		{
			...
			global::EPAM.NHModelingLanguage.NHModel modelRoot = this.RootElement as global::EPAM.NHModelingLanguage.NHModel;
			if (modelRoot != null)
			{
				...
				if (diagrams.Count > 0)
				{
					global::EPAM.NHModelingLanguage.NHDiagram diagram = diagrams[0] as global::EPAM.NHModelingLanguage.NHDiagram;
					if (diagram != null)
					{
		...
		{
			DslModeling::SerializationResult serializationResult = new DslModeling::SerializationResult();
			global::EPAM.NHModelingLanguage.NHModel modelRoot = (global::EPAM.NHModelingLanguage.NHModel)this.RootElement;
			...
			if (diagrams.Count > 0 && (!saveAs || this.diagramDocumentLockHolder == null))
			{
				...
				if (diagram != null)
				{
					...
					try
					{
						...
						global::EPAM.NHModelingLanguage.NHModelingLanguageSerializationHelper.Instance.SaveModelAndDiagram(serializationResult, modelRoot, fileName, diagram, diagramFileName, this.Encoding, false);
					}
					finally
					{
			...
			{
				global::EPAM.NHModelingLanguage.NHModelingLanguageSerializationHelper.Instance.SaveModel(serializationResult, modelRoot, fileName, this.Encoding, false);
			}
			// Report serialization messages.
			this.SuspendErrorListRefresh();
			try
			...
			if (serializationResult.Failed)
			{	// Save failed.
				throw new global::System.InvalidOperationException(global::EPAM.NHModelingLanguage.NHModelingLanguageDomainModel.SingletonResourceManager.GetString("CannotSaveDocument"));
			}
		}
		/// <summary>
			...
			if (diagrams.Count > 0)
			{
				...
				if (diagram != null)
				{
					try
					{
						...
						global::EPAM.NHModelingLanguage.NHModelingLanguageSerializationHelper.Instance.SaveDiagram(serializationResult, diagram, fileName, this.Encoding, false);
					}
					finally
					{
		...
		protected override string SerializedModel
		{
			get
			{
				...
				if (modelRoot != null)
				{
					modelFile = global::EPAM.NHModelingLanguage.NHModelingLanguageSerializationHelper.Instance.GetSerializedModelString(modelRoot, this.Encoding);
				}
				return modelFile;
			}
		}
